...
/***/ function(module, exports) {
	...
	const Board = function() {
	  ...
	  // this.board = [[4, undefined, undefined, 4], [4, undefined, undefined, 4], [4, undefined, undefined, 4], [4, undefined, undefined, 4]]
	};
	...
	Board.prototype.moveUpRow = function() {
	  moveOneRowUp(this.board);
	    // addNumbersRowUp(this.board[i]);
	}
	...
	//
	// function moveOneRowUp(arr) {
	//   for (let row = 1; row < arr.length; row++) {
	//     for (let column = 0; column < arr[row].length; column++){
	//       let altered = false;
	//       let current_tile = arr[row][column]
	//       for (let ahead = row - 1; ahead >= 0; ahead--) {
	//       }
	//
	//
	//
	//         if (current_tile === arr[ahead][column] && current_tile !== undefined && arr[ahead][column] !== undefined) {
	//           arr[ahead][column] = current_tile
	//
	//           let shiftval = ahead - 1;
	//
	//           while (shiftval < arr.length) {
	//             arr[shiftval][column] = arr[shiftval + 1][column]
	//             shiftval++;
	//           }
	//         }
	//
